...
export default function NewFireBlanketQuotePage() {
  ...
  async function doSave() {
    ...
    try {
      ...
      toast.success('방화포 견적서가 저장되었습니다.')
      localStorage.removeItem(DRAFT_KEY)
    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-gray-900">방화포 견적서 작성</h1>
        </div>
        <div className="flex items-center gap-3">
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="px-5 py-3.5 border-b border-gray-200 flex items-center gap-2">
          <span className="w-1 h-4 rounded-full flex-shrink-0 bg-[#014A99]" />
          <h2 className="font-semibold text-gray-800 text-sm">첨부파일 <span className="text-gray-400 font-normal">(선택)</span></h2>
        </div>
        <div className="p-5">
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-lg w-full mx-4 max-h-[85vh] flex flex-col">
            <h2 className="font-bold text-gray-900 text-lg mb-1">견적서 저장 확인</h2>
            <div className="text-sm text-gray-600 mb-4 flex items-center gap-2 flex-wrap">
              ...
              {deliveryDate && <><span className="text-gray-300">·</span><span className="text-gray-500">납품희망 {deliveryDate}</span></>}
            </div>
