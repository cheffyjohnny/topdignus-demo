...
export default function NonmetalFloorPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        >
          <div className="max-w-[980px] mx-auto px-4 sm:px-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold">비금속관 바닥 차열</h1>
          </div>
        </section>
        ...
        <section className="py-12 md:py-20 bg-white">
          <div className="max-w-[980px] mx-auto px-4 sm:px-6 flex flex-col gap-12 md:gap-20">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">비금속관 바닥 차열</h2>
              <ImageLightbox
                src="/킹스아시아_비금속관_PKTSP-2600-650_바닥.png"
                alt="비금속관 바닥 차열"
