...
export default function FlameDefenseBoxWPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        >
          <div className="max-w-[980px] mx-auto px-4 sm:px-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold">벽체 차염댐퍼시스템</h1>
            <p className="mt-4 opacity-80 text-sm md:text-base">Flame Defense Box W — Single Blade Damper</p>
          </div>
        </section>
        ...
        <section className="py-12 md:py-20 bg-white">
          <div className="max-w-[980px] mx-auto px-4 sm:px-6 flex flex-col gap-12 md:gap-20">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">금속 벽체 차염댐퍼시스템</h2>
