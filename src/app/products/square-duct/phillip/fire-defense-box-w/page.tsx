...
export default function FireDefenseBoxWPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        >
          <div className="max-w-[980px] mx-auto px-4 sm:px-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold">벽체 차열댐퍼시스템</h1>
            <p className="mt-4 opacity-80 text-sm md:text-base">Fire Defense Box W — Double Blade Damper</p>
          </div>
        </section>
        ...
        <section className="py-12 md:py-20 bg-white">
          <div className="max-w-[980px] mx-auto px-4 sm:px-6 flex flex-col gap-12 md:gap-20">
            ...
            <div>
              <h2 className="text-base md:text-xl font-bold text-gray-900 mb-2">금속 벽체 차열댐퍼시스템 (더블 블레이드 댐퍼)</h2>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <p className="text-xs uppercase tracking-widest text-gray-400 mb-2">제품구조</p>
                  <ImageLightbox
                    src="https://plfd.kr/user/attachment/202505/1748220333277310.jpg"
                    alt="제품구조"
                ...
                <div>
                  ...
                  <ImageLightbox
                    src="https://plfd.kr/user/attachment/202505/1747113726959542.jpg"
                    alt="제품사양"
                    className="w-full rounded-xl border border-gray-100"
                  />
                </div>
