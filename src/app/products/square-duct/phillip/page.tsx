...
const products = [
  {
    title: "금속 벽체 차열댐퍼시스템 (더블 블레이드 댐퍼)",
    href: "/products/square-duct/phillip/fire-defense-box-w",
  },
  {
    title: "금속 벽체 차염댐퍼시스템",
    href: "/products/square-duct/phillip/flame-defense-box-w",
  },
  {
    title: "금속 바닥 차열댐퍼시스템 (더블 블레이드 댐퍼)",
    href: "/products/square-duct/phillip/fire-defense-box-f",
  },
];

export default function PhillipDuctPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        >
          <div className="max-w-[980px] mx-auto px-4 sm:px-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold">덕트 내화채움구조</h1>
            <p className="mt-4 opacity-80 text-sm md:text-base">Duct Firestopping System</p>
          </div>
        </section>
        ...
        <section className="py-12 md:py-20 bg-white">
          <div className="max-w-[980px] mx-auto px-4 sm:px-6">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              덕트가 방화구획을 관통하는 부위에 설치하는 내화채움구조입니다. 벽체 및 바닥 관통부에 모두 적용 가능하며
              국내 기준에 적합한 성능 인증을 보유하고 있습니다.
            </p>
            ...
            <div className="flex flex-col">
              {products.map((item, index) => (
                <a
                  key={index}
                  href={item.href}
                  className="border-t border-black last:border-b flex items-center justify-between py-4 group"
                >
                  <div>
                  ...
                  <svg
                    className="w-4 h-4 text-black transition-transform group-hover:translate-x-1 shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
