...
export default function FloorSextiaPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        >
          <div className="max-w-[980px] mx-auto px-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold">층상용 섹스티아</h1>
            <p className="mt-4 opacity-80 text-sm md:text-base">Floor-Level Sextia</p>
          </div>
        </section>
          ...
          <div className="max-w-[980px] mx-auto px-6 flex flex-col gap-20">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">
                층상용 섹스티아 (바닥 비금속관 100A 이하) 층상배관 전용
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <p className="text-xs uppercase tracking-widest text-gray-400 mb-2">제품구조</p>
                  <img
                    src="https://plfd.kr/user/attachment/202505/1747113727842723.jpg"
                    alt="제품구조"
                ...
                <div>
                  ...
                  <img
                    src="https://plfd.kr/user/attachment/202505/1747113727842918.jpg"
                    alt="제품사양"
                    className="w-full rounded-xl border border-gray-100"
                  />
                </div>
