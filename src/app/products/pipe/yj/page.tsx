...
const categories = [
  { title: "입상배관 고정틀", href: "/products/pipe/yj/riser-pipe-frame" },
  { title: "내화일체형 고정틀", href: "/products/pipe/yj/fire-resistant-frame" },
  { title: "내화충전재", href: "/products/pipe/yj/fire-filler" },
  { title: "PVC 입상배관 제품", href: "/products/pipe/yj/pvc-riser-pipe" },
  { title: "고정앙카", href: "/products/pipe/yj/anchor" },
  { title: "기타 제품", href: "/products/pipe/yj/others" },
];

export default function YJPipePage() {
  return (
    <>
      <Navbar />
      <main>
